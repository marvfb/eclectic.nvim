...
M.global_bindings = {
	...
	["<C-@>"] = prims.actions.normal.bindings({
	...
	["<C-a>"] = prims.actions.normal.bindings({
	...
	["<C-e>"] = prims.actions.normal.bindings({
		prims.modes.nonterminal_modes,
		-- Has to be this way since a failed h/j/k/l cancels the command
		function()
			return uarg.pass_count(function(count)
	...
	["<C-g>"] = { prims.modes.command_mode, "<Esc>", { desc = "keyboard-quit" } },
	-- C-j is already a neovim binding
	["<C-k>"] = {
		{
			prims.modes.insert_mode,
			uarg.format_count(prims.actions.normal.from_insert("%dD"), {
				opposite = prims.actions.normal.from_insert("v0%dkd"),
				zero = prims.actions.normal.from_insert("v0d"),
			}),
			{ desc = "kill-line", expr = true },
		},
		{
			prims.modes.command_mode,
			uarg.format_count(
				prims.actions.normal.from_command("D"),
				{ opposite = prims.actions.normal.from_command("v0d"), zero = prims.actions.normal.from_command("v0d") }
			),
			{ desc = "kill-line", expr = true },
		},
	},
	...
	["<C-o>"] = {
		prims.modes.insert_mode,
		-- Not quite right
		uarg.repeat_times(prims.actions.normal.from_insert("O")),
		{ desc = "open-line", expr = true },
	},
	["<C-p>"] = {
		prims.modes.nonterminal_modes,
	...
	-- FIXME: Doesnt work
	-- ["<C-t>"] = prims.actions.normal.bindings( {
	-- 	prims.modes.editing_modes,
	-- 	function(normal)
	...
	["<C-v>"] = prims.actions.normal.bindings({
		prims.modes.navigation_modes,
		function(normal)
	...
	["<C-w>"] = {
		...
		{ prims.modes.visual_mode, "d", { desc = "kill-region" } },
	},
	["<C-y>"] = {
		{
			prims.modes.insert_mode,
			uarg.prefix_argument(
				prims.actions.normal.from_insert("p", "a"),
				prims.actions.normal.from_insert("p", "`[i")
			),
			{ desc = "yank", expr = true },
		},
		-- TODO: Maybe implement this under "custom functionality"
		{
			...
			uarg.prefix_argument(
				...
				end, prims.actions.normal.from_command("mzi<Left><Esc>p`z"))
			),
			{ desc = "yank", expr = true },
		},
	},
	...
	["<C-M-Bs>"] = prims.actions.visual.bindings({
		prims.modes.navigation_modes,
		function(visual)
	...
	["<C-S-Bs>"] = {
		prims.modes.insert_mode,
		uarg.format_count(
			prims.actions.normal.from_insert("%ddd"),
			{ opposite = prims.actions.normal.from_insert("V%dkd"), zero = prims.actions.normal.from_insert("0d$") }
		),
		{ desc = "kill-whole-line", expr = true },
	},
	["<C-Bs>"] = prims.actions.normal.bindings({
		prims.modes.editing_modes,
		function(normal)
	...
	["<C-h>a"] = {
		prims.modes.insert_mode,
		prims.actions.interactive_ex_command.from_insert("help "),
		{ desc = "about-emacs" },
	},
	...
	["<C-x><C-e>"] = prims.actions.visual.bindings({
		prims.modes.navigation_modes,
		function(visual)
	...
	["<C-x><C-f>"] = prims.actions.interactive_ex_command.bindings({
		prims.modes.all_modes,
		function(iex)
			return iex("e " .. get_cwd)
		end,
	...
	["<C-x><C-w>"] = prims.actions.interactive_ex_command.bindings({
		prims.modes.all_modes,
		function(iex)
	...
	["<C-x><C-x>"] = {
		...
		{ prims.modes.visual_mode, "o", { desc = "exchange-point-and-mark" } },
	},
	-- TODO: Theoretically, there is a prefix arg
	["<C-x><Space>"] = { prims.modes.visual_mode, "<C-v>", { desc = "rectangle-mark-mode" } },
	-- set-selective-display unimplemented
	-- TODO: Abbrevs
	["<C-x>'"] = { prims.modes.visual_mode, "<C-v>", { desc = "rectangle-mark-mode" } },
	-- TODO: Kmacros
	["<C-x>("] = { prims.modes.visual_mode, "<C-v>", { desc = "rectangle-mark-mode" } },
	["<C-x>)"] = { prims.modes.visual_mode, "<C-v>", { desc = "rectangle-mark-mode" } },
	["<C-x>*"] = { prims.modes.editing_modes, "<C-r>=", { desc = "calc-dispatch" } },
	...
	["<C-x><"] = prims.actions.normal.bindings({
		prims.modes.navigation_modes,
		function(normal)
			return uarg.pass_count(function(count)
	...
	["<C-x>b"] = prims.actions.interactive_ex_command.bindings({
		prims.modes.all_modes,
		function(iex)
			return iex("b ")
		end,
	...
	["<C-x>d"] = prims.actions.interactive_ex_command.bindings({
		prims.modes.all_modes,
		function(iex)
			return iex("e " .. get_cwd)
		end,
	...
	-- TODO: C-x C-+, etc. mode
	-- TODO: Test
	["<C-x><C-;>"] = prims.actions.normal.bindings({
		prims.modes.navigation_modes,
		function(normal)
	...
	["<C-M-@>"] = prims.actions.interactive_visual.bindings({
		prims.modes.navigation_modes,
		function(iv)
	...
	["<M->>"] = prims.actions.normal.bindings({
		prims.modes.navigation_modes,
	...
	["<M-a>"] = prims.actions.normal.bindings({
		prims.modes.navigation_modes,
		function(normal)
	...
	-- ["<M-c>"] = prims.actions.normal.bindings( {
	-- 	prims.modes.editing_modes,
	-- 	function(normal)
	...
	-- }),
	["<M-d>"] = prims.actions.normal.bindings({
		prims.modes.editing_modes,
		function(normal)
	...
	["<M-e>"] = prims.actions.normal.bindings({
		prims.modes.navigation_modes,
		function(normal)
	...
	["<M-h>"] = prims.actions.interactive_visual.bindings({
		prims.modes.navigation_modes,
		function(iv)
	...
	["<M-k>"] = prims.actions.normal.bindings({
		prims.modes.navigation_modes,
		function(normal)
	...
	["<M-l>"] = prims.actions.normal.bindings({
		prims.modes.editing_modes,
		function(normal)
	...
	["<M-m>"] = prims.actions.normal.bindings({
		prims.modes.navigation_modes,
		function(normal)
			return normal("^")
		end,
	...
	["<M-u>"] = prims.actions.normal.bindings({
		prims.modes.editing_modes,
		function(normal)
			return uarg.format_count(normal("%dgUw"), { opposite = normal("v%dbgU`]") })
		end,
	...
	-- TODO: Inaccurate
	["<M-v>"] = prims.actions.normal.bindings({
		prims.modes.navigation_modes,
		function(normal)
	...
	["<M-x>"] = prims.actions.interactive_ex_command.bindings({
		prims.modes.all_modes,
		function(iex)
			return iex("")
		end,
	...
	["<M-s>."] = prims.actions.normal.bindings({
		prims.modes.navigation_modes,
		function(normal)
	...
	["<M-s>o"] = prims.actions.interactive_ex_command.bindings({
		prims.modes.navigation_modes,
		function(iex)
			return iex("g/")
		end,
	...
	["<M-g><Tab>"] = prims.actions.normal.bindings({
		prims.modes.navigation_modes,
		function(normal)
	...
	-- idk what imenu is
	["<M-g>n"] = prims.actions.normal.bindings({
		prims.modes.navigation_modes,
		function(normal)
	...
	["<M-g>p"] = prims.actions.normal.bindings({
		prims.modes.navigation_modes,
		function(normal)
			return uarg.format_count(normal("%d[q"), { opposite = normal("%d]q") })
		end,
	...
	["<M-Esc>:"] = prims.actions.interactive_ex_command.bindings({
		prims.modes.all_modes,
		function(iex)
			return iex("lua ")
		end,
	...
	["<C-x>t<C-f>"] = prims.actions.interactive_ex_command.bindings({
		prims.modes.all_modes,
		function(iex)
	...
	["<C-x>td"] = prims.actions.interactive_ex_command.bindings({
		prims.modes.all_modes,
		function(iex)
	...
	["<C-x><Bs>"] = {
		prims.modes.insert_mode,
		uarg.format_count(
			prims.actions.normal.from_insert("v%d(d"),
			{ opposite = prims.actions.normal.from_insert("%dd)") }
		),
	...
	["<M-@>"] = {
		prims.modes.insert_mode,
		uarg.format_count(
			prims.actions.interactive_visual.from_insert("%deo"),
			{ opposite = prims.actions.interactive_visual.from_insert("%dbo") }
		),
	...
	["<C-x>4b"] = {
		prims.modes.insert_mode,
		uarg.sequence(
			select_other_window(prims.actions.normal.from_insert),
			prims.actions.interactive_ex_command.from_insert("e ")
		),
	...
	["<C-x>4."] = {
		...
		uarg.sequence(
			select_other_window(prims.actions.normal.from_insert),
			prims.actions.interactive_ex_command.from_insert("tag ")
		),
	...
	-- Formatting
	["<Tab>"] = {
		{ prims.modes.insert_mode, prims.actions.normal.from_insert("=="), { desc = "indent current line" } },
		{ prims.modes.visual_mode, "=", { desc = "indent region" } },
	},
	["<C-M-\\>"] = { prims.modes.visual_mode, "=", { desc = "indent region" } },
	["<M-^>"] = {
		prims.modes.insert_mode,
		uarg.prefix_argument("<Up>" .. prims.actions.normal.from_insert("J"), "J"),
	...
	-- Transposing
	["<M-t>"] = { prims.modes.editing_modes, custom_functionality.transpose_words, { desc = "transpose words" } },
	["<C-x><C-t>"] = { prims.modes.editing_modes, custom_functionality.transpose_lines, { desc = "transpose lines" } },

	-- Spelling Check
	["<M-$>"] = {
		prims.modes.insert_mode,
		prims.actions.normal.from_insert("z="),
...
M.lisp_interaction_mode_bindings = {
	["<C-j>"] = prims.actions.visual.bindings({
		prims.modes.navigation_modes,
		function(visual)
...
M.move_text = {
	["<M-Down>"] = prims.actions.visual.bindings({
		prims.modes.navigation_modes,
		function(visual)
			return uarg.pass_count(function(count)
				count = count or 1
	...
	["<M-Up>"] = prims.actions.visual.bindings({
		prims.modes.navigation_modes,
		function(visual)
			return uarg.pass_count(function(count)
				count = count or -1
